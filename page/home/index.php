...
<div class="container">
    ...
    <section class="about_us">
        <div class="bg_about-us"></div>

        <div class="discription">
            <div><img src="/img/logo_SpOn.svg"></div>
            <div>
                <p class="proximanova">SPACE Online – это уникальное пространство, первая и единственная
                    ...
                    любого из возможных специалистов тонких отраслей. И все это максимально
                    доступно благодаря специально разработанной, не имеющей аналогов в мире
                    платформе. Это портал для всех, кто хочет быть услышанным и разобраться со своим ценностями, для тех, кто хочет расти и развиваться.</p>
            </div>
            <div>
                <p class="montserrat">SPACE online - это территория гармонии, спокойствия, счастья, умиротворения, «мой личный тайный сад».</p>
            </div>
        </div>
    </section>

    <section id="choise_your_practises">
        <div class="title_practises">
            <span>Выбери свою практику</span>
            <p>Испытайте свой дух. Раслабь свой разум. Успокойся. Наша команда специалистов мирового класса даст вам возможность расти и достигать всех ваших целе в личностном и карьерном и оздоровлении.</p>
        </div>

        <div class="wrapper _choise_your_practises">
            <div class="slider">
                <div class="slider__item">
        ...
        <div class="slider_manage_block">
            <a href="#" class="link_to_practises">к списку практик</a>
    ...
    <section id="future_events">
        <div class="title__future_events">
        ...
        <div class="wrapper _future_events">
            <div class="slider">
                <div class="slider__item">
                    <img src="/img/bg_name_event1.png" alt="image">
                    <div class="date">
                        <p class="free_place">3/20</p>
                        <!-- <p>21/06/2020</p> -->
                    </div>
        ...
        <div class="slider_manage_block">
            <a href="#" class="">к списку событий</a>
            <div class="arrows"></div>
            <div class="dots"></div>
        </div>
    </section>
    ...
    <section id="from_organizers">
        <div class="title__from_organizers">
            <span>слово организаторов</span>
        </div>

        <div class="from_organizers__item">
            <div class="organizers_discription">
                <div>
                    <p>SPACE Online – это уникальное пространство, первая и единственная
                        масштабная русскоязычная платформа, которая позволит людям во всем мире
                        найти лучших мастеров во всех направлениях работы с телом, духом и душой
                        на Пути поиска Себя! У нас можно получить консультацию практически
                        любого из возможных специалистов тонких отраслей. </p>
                </div>
                <div class="space">
                    <p>Если ты тоже помогаешь людям увеличить их внутреннее пространство,
                        то становись частью нашей команды.
                    </p>
                </div>
                <div class="write">
                    <a href="#" type="button">Запишись прямо сейчас</a>
                </div>
            </div>

            <div class="bg_from_organizers">
            </div>
        </div>
